...
const Index = () => {
  ...
  const { data: featuredOpportunities, isLoading } = useQuery({
            ...
            {isLoading ? (
              ...
              featuredOpportunities.slice(0, 3).map((opportunity) => (
                <OpportunityCard
                  ...
                  timeCommitment={opportunity.commitment}
                  skills={opportunity.skills}
                  spotsAvailable={opportunity.spots_available}
                  rating={opportunity.rating}
                  isUrgent={opportunity.featured}
                />
              ))
            ) : (
              // Fallback to mock data if no opportunities
              <>
                <OpportunityCard
